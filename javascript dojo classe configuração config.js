define([
	...
	//Classe para carregar configurações do aplicativo web.Necessário criar arquivo config.json
	//no mesmo diretório desta classe para que as configurações sejam lidas para a classe.
